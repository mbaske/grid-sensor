...
public class FoodCollectorAgent : Agent
{
    ...
    // Freeze / unfreeze: replace detectable tag with custom observable.

    void Freeze()
    {
        //gameObject.tag = "frozenAgent";
        gameObject.GetComponentInChildren<DetectableAgent>().IsFrozen = true;
        m_Frozen = true;
    ...
    void Unfreeze()
    {
        ...
        gameObject.GetComponentInChildren<DetectableAgent>().IsFrozen = false;
        m_Frozen = false;
