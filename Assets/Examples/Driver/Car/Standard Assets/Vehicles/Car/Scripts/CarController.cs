...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        public bool IsGrounded() => Physics.Raycast(transform.position + Vector3.up, Vector3.down, 10, 1);
        public bool IsMoving() => m_Rigidbody.velocity.sqrMagnitude > 1;

        public float NormSteer => m_SteerAngle / m_MaximumSteerAngle;
        public float ForwardSpeed => Vector3.Dot(transform.forward, m_Rigidbody.velocity);
